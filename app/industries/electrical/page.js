    ...
    <>
      {/* Service hero */}
        ...
        <section className="section">
          <div className="container">
            <div className="industry-intro">
              ...
              <img loading="lazy" src="/images/industries/electrical-1.webp?v=2" alt="Industrial automation equipment"/>
            </div>
          </div>
        </section>
        ...
        <section className="section industry-sector">
          <div className="container grid-3 divided">
            ...
            <div className="industry-sector-col industry-sector-col-1">
              <img loading="lazy" src="/images/industries/electrical-2.webp" alt="Automated production line"/>
            </div>
            <div className="industry-sector-col industry-sector-col-2">
              <img loading="lazy" src="/images/industries/electrical-3.webp" alt="Industrial control systems"/>
            </div>
          </div>
        </section>
        ...
        <section className="industry-innovation">
          ...
          <img loading="lazy" src="/images/industries/electrical-1.webp?v=2" alt="Industrial automation technology"/>
        </section>
