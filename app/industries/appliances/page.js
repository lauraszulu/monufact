          ...
          <div className="container">
            <div className="industry-intro">
              ...
              <div className="img-frame">
                <img loading="lazy" className="img-frame-bg" src="/images/industries/appliances-1.webp?v=2" alt="" aria-hidden="true"/>
                <img loading="lazy" className="img-frame-fg" src="/images/industries/appliances-1.webp?v=2" alt="Industrial-scale appliance production facility"/>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section industry-sector">
          <div className="container grid-3 divided">
            ...
            <div className="industry-sector-col industry-sector-col-1">
              <img loading="lazy" src="/images/industries/appliances-2.webp" alt="Technician servicing a home appliance"/>
            </div>
            <div className="industry-sector-col industry-sector-col-2">
              <img loading="lazy" src="/images/industries/appliances-3.webp" alt="Technician repairing electronic equipment"/>
            </div>
          </div>
        </section>
