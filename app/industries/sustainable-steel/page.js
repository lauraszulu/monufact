    ...
    <>
      {/* Service hero */}
        ...
        <section className="industry-innovation">
          ...
          <img loading="lazy" src="/images/industries/sustainable-steel-2.webp" alt="Welder fabricating steel components"/>
        </section>
        ...
        <section className="split-cta">
          <div className="split-cta-left" style={{backgroundImage: "url('/images/industries/sustainable-steel-1.webp?v=2')"}}>
