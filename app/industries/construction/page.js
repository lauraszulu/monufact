      ...
      {/* Service hero */}
        ...
        <section className="section industry-sector">
          <div className="container grid-3 divided">
            ...
            <div className="industry-sector-col industry-sector-col-1">
              <img loading="lazy" src="/images/industries/construction-2.webp" alt="Construction crew at work"/>
            </div>
            <div className="industry-sector-col industry-sector-col-2">
              <img loading="lazy" src="/images/industries/construction-3.webp" alt="Building under construction"/>
            </div>
          </div>
        </section>
        ...
        <section className="industry-innovation">
          ...
          <div className="img-frame">
            <img loading="lazy" className="img-frame-bg" src="/images/industries/construction-1.webp?v=2" alt="" aria-hidden="true"/>
            <img loading="lazy" className="img-frame-fg" src="/images/industries/construction-1.webp?v=2" alt="Construction site"/>
          </div>
        </section>
        ...
        <section className="split-cta">
          <div className="split-cta-left" style={{backgroundImage: "url('/images/industries/construction-1.webp?v=2')"}}>
