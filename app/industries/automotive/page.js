export const metadata = {
  ...
  description: "Digital marketing and communications services for automotive manufacturers and suppliers across Canada and the United States.",
  openGraph: {
    title: "Automotive Industry Marketing - Monufact",
    description: "Digital marketing and communications services for automotive manufacturers and suppliers across Canada and the United States.",
...
export default function Page() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Service\", \"name\": \"Automotive Supplier Marketing\", \"description\": \"Digital marketing and communications services for automotive manufacturers and suppliers across Canada and the United States.\", \"provider\": {\"@type\": \"ProfessionalService\", \"name\": \"Monufact\", \"url\": \"https://monufact.com\"}, \"areaServed\": [\"CA\", \"US\"], \"url\": \"https://monufact.com/industries/automotive\"}" }} />
      {/* Service hero */}
        <section className="service-hero">
          <div className="container">
            <span className="eyebrow">/ Industries</span>
            <h1>Automotive Supplier Marketing</h1>
            <p className="service-intro">Marketing built to the same standards automotive suppliers in Canada and the United States are held to.</p>
          </div>
        </section>
        ...
        <section className="section industry-sector">
          <div className="container grid-3 divided">
            ...
            <div className="industry-sector-col industry-sector-col-1">
              <img loading="lazy" src="/images/industries/automotive-2.webp" alt="Automotive parts production"/>
            </div>
            <div className="industry-sector-col industry-sector-col-2">
              <img loading="lazy" src="/images/industries/automotive-3.webp" alt="Workers operating factory machinery"/>
            </div>
          </div>
        </section>
        ...
        <section className="split-cta">
          <div className="split-cta-left" style={{backgroundImage: "url('/images/industries/automotive-1.webp?v=2')"}}>
